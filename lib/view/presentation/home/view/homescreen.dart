                                      ...
                                      children: [
                                        ...
                                        Positioned(
                                          ...
                                          child: GestureDetector(onTap: ()async {
                                            context.read<HomeBloc>().add(HomeaddWhislistEvent(data));
                                            
                                          }, child:Icon(data.whish==1?CupertinoIcons.heart_fill: CupertinoIcons.heart,color:data.whish==1? ColorResources.BTNRED:null,)),
                                        )
                                      ],
                                    ),
                                    gap,
